    ...
    <div id="app">
        ...
        <div class="container lg:mx-auto p-4 lg:mt-10">
            ...
            <div class="mt-6">
                ...
                <news>
                    <news-tab title="STF" name="stf" provider="stf" :count="10" :selected="true"></news-tab>
                    <news-tab title="STJ" name="stj" provider="stj" :count="10"></news-tab>
                    <news-tab title="TST" name="tst" provider="tst" :count="10"></news-tab>
                    <news-tab title="TJMG" name="tjmg" provider="tjmg" :count="10"></news-tab>
                </news>
