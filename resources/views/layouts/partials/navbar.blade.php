<nav class="flex items-center justify-between flex-wrap bg-grey-light p-4 lg:p-0">
    ...
    <div class="block lg:hidden">
        <button onclick="toggleMenu()"
                class="flex items-center px-3 py-2 border rounded text-blue-darker border-blue-darker hover:text-blue-dark hover:border-blue-dark">
    ...
    <div id="menu"
         class="w-full lg:flex hidden lg:justify-around">
