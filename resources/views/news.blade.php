...
@section('content')
    ...
    <section class="container mx-auto">
        ...
        <div class="mt-10 leading-tight">
            ...
            <div id="app">
                <news>
                    <news-tab title="STF" name="stf" provider="stf" :selected="true"></news-tab>
                    <news-tab title="STJ" name="stj" provider="stj"></news-tab>
                    <news-tab title="TST" name="tst" provider="tst"></news-tab>
                    <news-tab title="TJMG" name="tjmg" provider="tjmg"></news-tab>
                </news>
            </div>
