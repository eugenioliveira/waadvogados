...
<section class="container p-4 mx-auto">
    ...
    <div class="mt-10">
        ...
        <div class="w-full flex flex-col md:flex-row items-center bg-blue-lightest border border-blue-darker rounded-lg p-4 my-4">
            <div>
                <img class="rounded-lg w-32 h-32 shadow-outline m-2"
                     src="/img/WOLNEY.jpeg">
            </div>
            <div class="ml-4 flex-1">
                <h1 class="font-serif text-blue-darker text-center md:text-left">WOLNEY ARAÚJO DIAS JÚNIOR</h1>
        ...
        <div class="w-full flex flex-col md:flex-row items-center bg-blue-lightest border border-blue-darker rounded-lg p-4 my-4">
            ...
            <div class="ml-4 flex-1">
                <h1 class="font-serif text-blue-darker text-center md:text-left">DAVI BRANQUINHO DA COSTA DIAS</h1>
        ...
        <div class="w-full flex flex-col md:flex-row items-center bg-blue-lightest border border-blue-darker rounded-lg p-4 my-4">
            ...
            <div class="ml-4 flex-1">
                <h1 class="font-serif text-blue-darker text-center md:text-left">JOÃO PAULO SALLES PINTO</h1>
        ...
        <div class="w-full flex flex-col md:flex-row items-center bg-blue-lightest border border-blue-darker rounded-lg p-4 my-4">
            ...
            <div class="ml-4 flex-1">
                <h1 class="font-serif text-blue-darker text-center md:text-left">PALOMA BERNARDES LAGO DE SOUSA</h1>
